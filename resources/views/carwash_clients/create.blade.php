    ...
    <div class="container">
        ...
        <form action="{{ route('carwash_clients.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="unp" id="unp" class="form-control @error('unp') is-invalid @enderror" value="{{ old('unp') }}" maxlength="9" required>
                @error('unp')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="bank_account_number" id="bank_account_number" class="form-control @error('bank_account_number') is-invalid @enderror" value="{{ old('bank_account_number') }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="bank_bic" id="bank_bic" class="form-control @error('bank_bic') is-invalid @enderror" value="{{ old('bank_bic') }}" required>
                @error('bank_bic')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <input type="checkbox" name="invoice_email_required" id="invoice_email_required" class="form-check-input @error('invoice_email_required') is-invalid @enderror" value="1" {{ old('invoice_email_required', 1) ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="invoice_email_day" id="invoice_email_day" class="form-control @error('invoice_email_day') is-invalid @enderror" value="{{ old('invoice_email_day', 5) }}" min="1" max="31">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="postal_address" id="postal_address" class="form-control @error('postal_address') is-invalid @enderror" value="{{ old('postal_address') }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="bank_postal_address" id="bank_postal_address" class="form-control @error('bank_postal_address') is-invalid @enderror" value="{{ old('bank_postal_address') }}" required>
