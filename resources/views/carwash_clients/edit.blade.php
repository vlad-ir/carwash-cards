                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="short_name" id="short_name"
                               ...
                               value="{{ old('short_name', $client->short_name) }}" required>
                        @error('short_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="unp" id="unp"
                               ...
                               value="{{ old('unp', $client->unp) }}" maxlength="9" required>
                        @error('unp')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="postal_address" id="postal_address"
                               ...
                               value="{{ old('postal_address', $client->postal_address) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="bank_account_number" id="bank_account_number"
                               ...
                               value="{{ old('bank_account_number', $client->bank_account_number) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="bank_bic" id="bank_bic"
                               ...
                               value="{{ old('bank_bic', $client->bank_bic) }}" required>
                        @error('bank_bic')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="bank_postal_address" id="bank_postal_address"
                               ...
                               value="{{ old('bank_postal_address', $client->bank_postal_address) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="contract" id="contract"
                               ...
                               value="{{ old('contract', $client->contract) }}">
                        @error('contract')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="invoice_email_required" id="invoice_email_required"
                                   ...
                                   value="1" {{ old('invoice_email_required', $client->invoice_email_required) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="invoice_email_day" id="invoice_email_day"
                               ...
                               value="{{ old('invoice_email_day', $client->invoice_email_day) }}" min="1" max="31">
