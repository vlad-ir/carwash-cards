...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::post('/carwash_clients/update_tariff_for_selected', [CarwashClientController::class, 'updateTariffForSelected'])->name('carwash_clients.update_tariff_for_selected');
